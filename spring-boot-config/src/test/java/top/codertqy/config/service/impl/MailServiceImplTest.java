...
class MailServiceImplTest {
    ...
    void sendAttachmentsMail() throws Exception {
        ...
        // 本地文件
        File file1 = new File("D:\\pictures\\dobao.jpg");
        File file2 = new File("D:\\pictures\\tx.jpg");
        // File转换为MultipartFile
        MultipartFile[] files = new MultipartFile[2];
        files[0] = new MockMultipartFile(file1.getName(), file1.getName(), "image/jpeg", FileCopyUtils.copyToByteArray(file1));
        files[1] = new MockMultipartFile(file2.getName(), file2.getName(), "image/jpeg", FileCopyUtils.copyToByteArray(file2));
